 ...
 * - Motions: h j k l, 0, $, w, b, e, f<char>, t<char>
 * - Editing: x, d + motion, dd, D, i, a, o, O, J
 */
...
class ModalEditor extends CustomEditor {
	...
	private getModeBorderColor(base: (text: string) => string): (text: string) => string {
		...
		if (this.mode === "normal") {
			return activeTheme.getThinkingBorderColor("low");
		}
		if (this.mode === "visual") {
			return activeTheme.getThinkingBorderColor("high");
		}
		return base;
	}
