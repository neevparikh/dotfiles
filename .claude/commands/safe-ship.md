...
**Prerequisites:** This workflow uses `/analyze`, `/push-pr`, `/code-review:code-review`, and `/watch-ci-merge`. Ensure these are available.

## Phase 1: Pre-Push Analysis

1. Check for changes: `git status` — if no changes, report and stop
...
1. **Run `/code-review:code-review`** on the PR
